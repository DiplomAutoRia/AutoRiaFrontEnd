...
import { ArrowBack, CalendarToday, DirectionsCar, LocalGasStation, LocationOn, Speed } from '@mui/icons-material';
  ...
  if (error) {
    return (
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Button variant="contained" sx={{ mt: 2, mx: 'auto', display: 'block' }} onClick={() => navigate('/')}>
          На головну
        </Button>
      </Container>
    );
            ...
            <Grid item xs={12} md={6}>
              ...
              <Stack spacing={2} sx={{ mb: 3 }}>
                ...
                <Stack direction="row" alignItems="center" spacing={1}>
                  <Speed color="action" />
                  <Typography variant="body1">
                    <strong>Пробіг:</strong> {vehicle.mileage.toLocaleString()} км
                  </Typography>
                </Stack>
                ...
                <Stack direction="row" alignItems="center" spacing={1}>
                  ...
                  <Typography variant="body1">
                    <strong>Паливо:</strong> {vehicle.fuel_type}
                  </Typography>
                </Stack>
                ...
                <Stack direction="row" alignItems="center" spacing={1}>
                  ...
                  <Typography variant="body1">
                    <strong>Коробка передач:</strong> {vehicle.transmission}
                  </Typography>
                </Stack>
                ...
                <Stack direction="row" alignItems="center" spacing={1}>
                  ...
                  <Typography variant="body1">
                    <strong>Місцезнаходження:</strong> {vehicle.location}
                  </Typography>
                </Stack>
              </Stack>
            ...
            <Grid item xs={12}>
              ...
              <Paper elevation={0} sx={{ p: 2, backgroundColor: '#f9f9f9', borderRadius: 2 }}>
                {vehicle.description ? (
                  ...
                  <Typography>
                    Продавець не надав додатковий опис. Ви можете зв'язатися з продавцем для отримання більше
                    інформації.
                  </Typography>
                )}
              </Paper>
