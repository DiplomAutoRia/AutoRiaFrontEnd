      ...
      <form onSubmit={handleSubmit}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', gap: 4 }}>
          ...
          <Box sx={{ minWidth: 120 }}>
            <Stack spacing={2} sx={{ height: '100%', justifyContent: 'space-around' }}>
              <Typography variant="body2" sx={{ textAlign: 'left', height: '40px', display: 'flex', alignItems: 'center' }}>
                Ім'я:
              </Typography>
              <Typography variant="body2" sx={{ textAlign: 'left', height: '40px', display: 'flex', alignItems: 'center' }}>
                Прізвище:
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', mt: 2 }}>
          <Button 
            ...
            variant="contained" 
            size="small"
            sx={{ borderRadius: 0, minWidth: '200px' }}
          >
            Зберегти зміни
          </Button>
        </Box>
    ...
    <Paper elevation={1} sx={{ borderRadius: 0, p: 3, mt: 3 }}>
      <Box sx={{ textAlign: 'left' }}>
        ...
        <Typography variant="body2" sx={{ mb: 3, color: 'text.secondary' }}>
          Ми надсилатимемо сповіщення про ваші оголошення та важливі події на ці контактні дані. 
          Вони не будуть видимі іншим користувачам
        </Typography>
