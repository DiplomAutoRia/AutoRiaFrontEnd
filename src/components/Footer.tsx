...
const MESSENGERS = [
  {
    ...
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path fill="#fff" d="M12 2C6.48 2 2 6.02 2 11.1c0 2.7 1.13 5.13 3.13 6.93v3.07c0 .41.47.65.8.4l2.73-2.18c.44.12.9.22 1.34.28.61.08 1.23.12 1.87.12 5.52 0 10-4.02 10-9.1S17.52 2 12 2Zm.13 13.1-2.1-2.23-4.13 2.23 5.13-5.6 2.1 2.23 4.13-2.23-5.13 5.6Z"/>
      </svg>
    ),
    href: '#',
  },
  {
    ...
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path fill="#fff" d="M21.05 3.52 3.94 10.36c-1.34.52-1.33 1.25-.24 1.58l4.17 1.3 1.6 5.13c.21.67.38.93.78.93.4 0 .56-.15.77-.67l2.15-5.1 4.47 4.13c.82.72 1.41.35 1.61-.67l2.91-13.07c.23-1.04-.38-1.5-1.11-1.07Z"/>
      </svg>
    ),
    href: '#',
  },
  {
    ...
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path fill="#fff" d="M17.472 2.5H6.528A4.03 4.03 0 0 0 2.5 6.528v10.944A4.03 4.03 0 0 0 6.528 21.5h10.944A4.03 4.03 0 0 0 21.5 17.472V6.528A4.03 4.03 0 0 0 17.472 2.5Zm-5.472 15a7 7 0 1 1 0-14 7 7 0 0 1 0 14Zm0-12.5a5.5 5.5 0 1 0 0 11 5.5 5.5 0 0 0 0-11Z"/>
      </svg>
    ),
    href: '#',
  },
  {
    ...
    icon: (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path fill="#fff" d="M6.62 10.79a15.053 15.053 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.01-.24c1.12.37 2.33.57 3.58.57a1 1 0 0 1 1 1v3.61a1 1 0 0 1-1 1C7.61 21 3 16.39 3 11a1 1 0 0 1 1-1h3.61a1 1 0 0 1 1 1c0 1.25.2 2.46.57 3.58a1 1 0 0 1-.24 1.01l-2.2 2.2Z"/>
      </svg>
    ),
    href: '#',
  },
      ...
      <section className="flex-1 flex flex-col items-start md:items-end">
        <div className="w-full md:w-auto">
          ...
          <p className="mb-4 text-sm text-blue-100">
            все для купівлі та продажу авто у вашому смартфоні
          </p>
